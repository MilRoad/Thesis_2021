...
class CVRPInfo(object):
    ...
    def __init__(self, distance_matrix, demand, capacity, dimension, coords, start_node=1, debug=False):
    ...
    def compute_dists(self):
        ...
        for xi in range(self.dimension + 1):
            for yi in range(self.dimension + 1):
                self.dist[xi][yi] = self.distance_matrix[xi-1][yi-1]
    ...
    def make_random_solution(self, greedy=False):
        ...
        while unserviced:
            ...
            route_demand = 0
            route_length = 0
        routes += [self.make_route(cur_route + [2, 1])]
        junk = ""
